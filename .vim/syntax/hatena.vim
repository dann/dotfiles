...
syn region hatenaCancelP		matchgroup=hatenaBlockDelimiter start=+>\ze<+ end=+>\zs<$+ contains=htmlTag

syn cluster hatenaSpecials		contains=hatenaDefColon,hatenaTableSeparator
...
syn region hatenaBlockQuote	matchgroup=hatenaBlockDelimiter start=+^>>+  end=+<<+ contains=ALLBUT,@hatenaSpecials
syn region hatenaPre		matchgroup=hatenaBlockDelimiter start=+^>|+  end=+|<+ contains=ALLBUT,@hatenaSpecials
syn region hatenaSuperPre	matchgroup=hatenaBlockDelimiter start=+^>||+ end=+||<+
syn cluster hatenaBlocks	contains=hatenaPre,hatenaSuperPre,hatenaBlockQuote
